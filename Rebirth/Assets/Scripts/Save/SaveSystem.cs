...
public class SaveSystem
{
   ...
   #region Inventory
    ...
    {
        // Make Struct InventoryItemData {int cellNum, ItemData itemData}

        // Save InventoryItemDatas by iterating DataContainer
            // cellNum = InventoryItemObj.parent.num;
            // itemData = InventoryItemObj.GetComponent<InventoryItem>().itemData;
    ...
    {
        // Iterate
            // Get Matching ItemData
            // Make new InventoryDataObj
            // Allocate to matching cell
